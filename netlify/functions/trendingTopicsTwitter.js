...
mongoose.connect('mongodb://localhost:27017/trendingTopicsTwitter', { useNewUrlParser: true, useUnifiedTopology: true });
...
async function fetchTrendingTopics() {
    ...
    try {
        ...
        for (let i = 0; i < trendElements.length; i++) {
            ...
            // Only add non-duplicate and non-empty trends
            if (trendText.trim() && trendText.startsWith('#') && !top5Trends.includes(trendText) && trendCount < 5) {
